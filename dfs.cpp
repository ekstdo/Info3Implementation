...
public:
	dfs(const graph &G_, std::vector<int>& previous_, std::vector<int>& starting_, std::vector<int>& finished_): G(G_), previous(previous_), start(starting_), finished(finished_), states(G.edges.size(), unvisited) {
